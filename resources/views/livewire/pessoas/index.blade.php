                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3 flex justify-end items-center gap-x-1.5">
                                            ...
                                            @can('usuarios.gerenciar_permissoes')
                                                @if($pessoa->usuario)
                                                    <a href="{{ route('usuarios.permissoes', $pessoa->usuario) }}" wire:navigate
                                                        class="p-2 inline-flex items-center justify-center rounded-lg bg-warn hover:bg-warn-hover text-white"
                                                        title="{{ __('Permissões') }}">

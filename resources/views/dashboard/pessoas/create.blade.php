<x-layouts.app :title="__('Cadastro de Pessoa')">
    <div class="max-w-5xl mx-auto pb-12" x-data="{
        ...
        <form action="{{ route('pessoas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            {{-- Título --}}
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-ink tracking-tight">{{ __('Novo Cadastro') }}</h2>
                <div class="flex items-center gap-3 mt-2">
                    <p class="text-sm text-ink-muted">Informações completas para o registro da pessoa e usuário.</p>
                    <span
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="space-y-6">
                    <div class="bg-surface border border-border rounded-2xl p-8 text-center shadow-sm">
                        <div class="relative inline-block group">
                            <label class="block cursor-pointer">
                                <div
                                    ...
                                    <img x-show="fotoUrl" x-cloak :src="fotoUrl" alt="Prévia"
                        ...
                        <p class="text-xs text-ink-muted mt-1 italic">Clique no círculo para adicionar</p>
                    ...
                    <div class="bg-surface border border-border rounded-2xl p-7 shadow-sm h-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="doc_profissional" value="{{ old('doc_profissional') }}"
            ...
            <div class="bg-surface border border-border rounded-2xl overflow-hidden shadow-sm mt-8">
                <div class="p-7 bg-border/20 flex items-center justify-between border-b border-border">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-ink-muted">Opcional. Nem toda pessoa precisa de conta no sistema.</p>
                        </div>
                    </div>
                ...
                {{-- Conteúdo só aparece com o toggle ligado --}}
                ...
                <div x-show="!criarAcesso" class="p-7 text-center">
                    <p class="text-sm text-ink-muted">
                        Esta pessoa será cadastrada <span class="text-ink font-medium">sem acesso ao sistema</span>.

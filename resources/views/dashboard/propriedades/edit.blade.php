...
<x-layouts.app :title="__('Editar Propriedade')">
    <div class="max-w-5xl mx-auto pb-12" x-data="{
        ...
        <form action="{{ route('propriedades.update', $propriedade) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-8 flex items-start justify-between gap-4">
                <div>
                    <div class="flex items-center gap-2 text-xs text-ink-muted mb-1">
                        <a href="{{ route('propriedades.index') }}" class="hover:text-ink">{{ __('Propriedades') }}</a>
                        <span>/</span>
                        <span class="text-primary-light">#{{ $propriedade->id }}</span>
                    </div>
                    <h2 class="text-3xl font-bold text-ink tracking-tight">{{ __('Editar Propriedade') }}</h2>
                    <div class="flex items-center gap-3 mt-2">
                        <p class="text-sm text-ink-muted">{{ $propriedade->razao_social }}</p>
                        <span
                ...
                <div class="text-end text-xs text-ink-muted shrink-0">
                    <p>{{ __('Criado em') }} {{ $propriedade->created_at->format('d/m/Y H:i') }}</p>
                    @if ($propriedade->updated_at && $propriedade->updated_at->ne($propriedade->created_at))
                        <p>{{ __('Atualizado') }} {{ $propriedade->updated_at->diffForHumans() }}</p>
                    @endif
                </div>
            </div>
                        ...
                        <div class="flex items-center justify-between p-4 bg-canvas rounded-xl border border-border">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="eh_ativo" value="1" class="sr-only peer"
                                    @checked(old('eh_ativo', $propriedade->eh_ativo))>
                                <div
                        ...
                        <div>
                            ...
                            <select name="produtor_id" required
                                ...
                                @foreach ($produtores as $p)
                                    <option value="{{ $p->id }}"
                                        @selected(old('produtor_id', $propriedade->produtor_id) == $p->id)>
                                        {{ $p->nome_completo }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-5">
                            <div class="md:col-span-6">
                                ...
                                <input type="text" name="razao_social"
                                    value="{{ old('razao_social', $propriedade->razao_social) }}" required
                            ...
                            <div class="md:col-span-6">
                                ...
                                <input type="text" name="nome_fantasia"
                                    value="{{ old('nome_fantasia', $propriedade->nome_fantasia) }}"
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="cnpj"
                                    value="{{ old('cnpj', $propriedade->cnpj_formatado) }}" @input="mascaraCnpj"
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="ie" value="{{ old('ie', $propriedade->ie) }}"
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="nrif" value="{{ old('nrif', $propriedade->nrif) }}"
                            ...
                            <div class="md:col-span-3">
                                ...
                                <input type="text" name="car" value="{{ old('car', $propriedade->car) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="area_total"
                            value="{{ old('area_total', $propriedade->area_total) }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="area_consolidada"
                            value="{{ old('area_consolidada', $propriedade->area_consolidada) }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="area_reservada_legal"
                            value="{{ old('area_reservada_legal', $propriedade->area_reservada_legal) }}"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="area_app"
                            value="{{ old('area_app', $propriedade->area_app) }}"
                    ...
                    <div class="md:col-span-4">
                        ...
                        <input type="number" min="0" name="capacidade_armazenamento"
                            value="{{ old('capacidade_armazenamento', $propriedade->capacidade_armazenamento) }}"
            ...
            <div class="bg-surface border border-border rounded-2xl p-7 shadow-sm mt-8">
                ...
                <x-form.endereco :endereco="[
                    'cep' => old('cep', $propriedade->cep_formatado),
                    'logradouro' => old('logradouro', $propriedade->logradouro),
                    'numero' => old('numero', $propriedade->numero),
                    'bairro' => old('bairro', $propriedade->bairro),

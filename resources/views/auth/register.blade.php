    ...
    <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-2xs">
        <div class="p-4 sm:p-7">
            <div class="text-center">
                <h3 class="block text-2xl font-bold text-gray-800 dark:text-neutral-200">Criar conta</h3>
                <p class="mt-2 text-sm text-gray-600 dark:text-neutral-300">
                    Já tem uma conta?
                    <a class="text-blue-600 dark:text-blue-500 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium"
                        href="{{ route('login') }}">
                        Entre aqui
                    </a>
                </p>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid gap-y-4">
                        ...
                        <div>
                            ...
                            @error('name') <p class="text-xs text-red-600 mt-2" id="name-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            <label for="email"
                                class="block text-sm mb-2 text-gray-800 dark:text-neutral-200">E-mail</label>
                            <div class="relative">
                                <input type="email" id="email" name="email" value="{{ old('email') }}"
                                    class="py-2.5 sm:py-3 px-4 block w-full bg-white dark:bg-neutral-800 border-gray-200 dark:border-neutral-700 rounded-lg sm:text-sm text-gray-800 dark:text-neutral-200 placeholder:text-gray-500 dark:placeholder:text-neutral-400 focus:border-blue-700 dark:focus:border-blue-600 focus:ring-blue-700 dark:focus:ring-blue-600 disabled:opacity-50 disabled:pointer-events-none @error('email') !border-red-500 @enderror"
                                    required aria-describedby="email-error">
                                <div
                                    class="{{ $errors->has('email') ? '' : 'hidden' }} absolute inset-y-0 inset-e-0 pointer-events-none pe-3 flex items-center">
                                    <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor"
                                        viewBox="0 0 16 16" aria-hidden="true">
                                        <path
                                            d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                            ...
                            @error('email') <p class="text-xs text-red-600 mt-2" id="email-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div x-data="{ show: false }">
                            <label for="password"
                                class="block text-sm mb-2 text-gray-800 dark:text-neutral-200">Senha</label>
                            <div class="relative">
                            ...
                            @error('password') <p class="text-xs text-red-600 mt-2" id="password-error">{{ $message }}
                            </p> @enderror
                        </div>
                        ...
                        <div x-data="{ show: false }">
                            <label for="password_confirmation"
                                class="block text-sm mb-2 text-gray-800 dark:text-neutral-200">Confirmar senha</label>
                            <div class="relative">
                        ...
                        <!-- <div class="flex items-center">
                            <div class="flex">
                                <input id="terms" name="terms" type="checkbox" class="shrink-0 size-4 bg-transparent border-gray-300 dark:border-neutral-600 rounded-sm shadow-2xs text-blue-600 dark:text-blue-500 focus:ring-0 focus:ring-offset-0 checked:bg-blue-600 dark:checked:bg-blue-500 checked:border-blue-600 dark:checked:border-blue-500">
                            </div>
                            <div class="ms-3">
                                <label for="terms" class="text-sm text-gray-800 dark:text-neutral-200">
                                    Aceito os <a class="text-blue-600 dark:text-blue-500 decoration-2 hover:underline focus:outline-hidden focus:underline font-medium" href="#">Termos e Condições</a>
                                </label>
                            </div>
                        </div> -->

                        <button type="submit"
                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg bg-blue-600 dark:bg-blue-500 border border-transparent text-white hover:bg-blue-700 dark:hover:bg-blue-600 focus:outline-hidden focus:bg-blue-700 dark:focus:bg-blue-600 disabled:opacity-50 disabled:pointer-events-none">Cadastrar</button>
                    </div>
                </form>
                <!-- End Form -->
            </div>
